...
- Rebuild pre-cache generates schedule phrases and current-heat "[name], Lap [n]" phrases under `tts/<model>/precache/`.
...
- [x] **Rebuild pre-cache** quick button → pre-cache schedule and current heat pilot/lap phrases on demand
...
- [x] **Rebuild pre-cache** pre-synthesizes "[name], Lap [n]" for all pilots in the current heat
...
- [x] Pilot names and lap numbers are pre-generated by **Rebuild pre-cache**; generation time logged
